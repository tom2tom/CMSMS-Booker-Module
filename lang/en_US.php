...
$lang['feemodtitle'] = 'Update fees for use of resource %s';
$lang['feemodtitle1'] = 'Update fees for use of resource %s and other(s)';
$lang['feemodtitle2'] = 'Update fees for use of resources in group %s';
$lang['feemodtitle3'] = 'Update fees for use of resources in group %s and other(s)';
$lang['feeseetitle'] = 'Fees for use of resource %s';
$lang['feeseetitle2'] = 'Fees for use of resources in group %s';
...
$lang['group_page_title'] = 'RESOURCE-GROUP DETAILS';
...
$lang['help_book_style'] = 'Tabular displays of bookings data are styled using this parameter';
...
$lang['help_subgrpalloc'] = 'When booking less than the whole group, the specific resources will be determined according to this, when possible';
...
$lang['item_page_title'] = 'RESOURCE DETAILS';
$lang['item'] = 'resource';
...
$lang['tip_notify_selected_requests'] = 'send notice to lodger of each selected request';
...
$lang['tip_sortmems'] = 'sort group members by similarity (name,description and/or keywords)';
...
$lang['title_feecondition'] = 'Circumstances when fee applies';
...
$lang['title_when'] = 'Starting when';
$lang['title_whenpast'] = 'Booking started';
...
//messages - inward
$lang['email_reqchange'] = 'A request to change booking of %s on %s has been submitted';
$lang['email_reqchange_title'] = 'Booking change submitted';
$lang['email_reqchangeat'] = 'A request to change booking of %s on %s at %s has been submitted';
$lang['email_request'] = 'A request to book %s on %s has been submitted';
$lang['email_request_title'] = 'Booking request submitted';
$lang['email_requestat'] = 'A request to book %s on %s at %s has been submitted';
//sms|tweet
$lang['text_reqchange'] = 'Request submitted - change booking of %s on %s';
$lang['text_reqchangeat'] = 'Request submitted - change booking of %s on %s at %s';
$lang['text_request'] = 'Request submitted - book %s on %s';
$lang['text_requestat'] = 'Request submitted - book %s on %s at %s';
//messages - outward NOTE '[' and ']', where used, must be retained
$lang['email_approve'] = 'The booking of %s on %s has been approved. [optional extra]';
$lang['email_approve_title'] = 'Booking request approved';
$lang['email_approveat'] = 'The booking of %s on %s at %s has been approved. [optional extra]';
$lang['email_approveatpay'] = 'The booking of %s on %s at %s has been approved, subject to payment of the %s fee';
$lang['email_approvepay'] = 'Your booking of %s on %s has been approved, subject to payment of the %s fee';
$lang['email_ask'] = 'Please lodge further information about the booking of %s on %s - [send]';
$lang['email_ask_title'] = 'Booking request - information needed';
$lang['email_askat'] = 'Please lodge further information about the booking of %s on %s at %s - [send]';
$lang['email_cancel'] = 'The booking of %s on %s must be cancelled, because [reason]';
$lang['email_cancelat'] = 'The booking of %s on %s at %s must be cancelled, because [reason]';
$lang['email_cancelled_title'] = 'Booking cancelled';
$lang['email_changed'] = 'The booking of %s on %s must be changed, because [reason]. Please re-book.';
$lang['email_changed_title'] = 'Booking changed';
$lang['email_changedat'] = 'The booking of %s on %s at %s must be changed, because [reason]. Please re-book.';
$lang['email_conflict'] = 'The booking of %s on %s can\'t proceed, due to scheduling conflict';
$lang['email_conflictat'] = 'The booking of %s on %s at %s can\'t proceed, due to scheduling conflict';
$lang['email_reject'] = 'The booking of %s on %s can\'t proceed, because [reason]';
$lang['email_reject_title'] = 'Booking request rejected';
$lang['email_rejectat'] = 'The booking of %s on %s at %s can\'t proceed, because [reason]';
//sms|tweet
$lang['text_approve'] = 'Booking approved, %s on %s';
$lang['text_approveat'] = 'Booking approved, %s on %s at %s';
$lang['text_approveatpay'] = 'Booking approved, %s on %s at %s, must pay %s fee';
$lang['text_approvepay'] = 'Booking approved, %s on %s, must pay %s fee';
$lang['text_ask'] = 'Further information needed about the booking of %s on %s - [send]';
$lang['text_askat'] = 'Further information needed about the booking of %s on %s at %s - [send]';
$lang['text_cancel'] = 'Booking cancelled, %s on %s, [reason]';
$lang['text_cancelat'] = 'Booking cancelled, %s on %s at %s, [reason]';
$lang['text_change'] = 'Must change booking, %s on %s, [reason]. Please re-book.';
$lang['text_changeat'] = 'Must change booking, %s on %s at %s, [reason]. Please re-book.';
$lang['text_conflict'] = 'Booking cancelled, %s on %s, scheduling conflict';
$lang['text_conflictat'] = 'Booking cancelled, %s on %s at %s, scheduling conflict';
$lang['text_reject'] = 'Booking rejected, %s on %s, [reason]';
$lang['text_rejectat'] = 'Booking rejected, %s on %s at %s, [reason]';
