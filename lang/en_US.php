...
$lang['confirm_del_sel'] = 'Are you sure you want to delete the selected %s?';
$lang['confirm_del_type'] = 'Are you sure you want to delete %s \\\'%s\\\' ?';
//$lang['confirm_fresh'] = 'Are you sure you want to refresh %s?';
$lang['confirm_fresh_sel'] = 'Are you sure you want to refresh the selected %s?';
$lang['confirm_fresh_type'] = 'Are you sure you want to refresh %s \\\'%s\\\' ?';
...
$lang['current_credit'] = 'Current <strong>%s</strong> : %s';
$lang['credit'] = 'credit';
...
$lang['currentdesc3'] = '<strong>%s has been requested</strong>, from %s to %s.';
$lang['currentdesc4'] = '<strong>%d</strong> are vacant'; //'all %d are vacant';
$lang['currentdesc5'] = '<strong>%d</strong> are vacant'; //'%d of the %d are vacant';
$lang['currentdesc6'] = '<strong>1</strong> is vacant'; //'1 of the %d is vacant';
$lang['currentdesc7'] = '<strong>none</strong> is vacant';
$lang['currentdesc10'] = '<strong>%d</strong> have been requested';
$lang['currentdesc11'] = '<strong>1</strong> has been requested';
...
$lang['err_dup'] = 'Nominated time is already booked';
$lang['err_file'] = 'Inappropriate file was specified';
$lang['err_na'] = 'Resource is not available during the specified interval';
...
$lang['help_credit'] = 'Enter a new total (like %s) to be set, or a relative amount (like +/- %s) to change';
...
<p>The first line of the file names the fields in the file, as follows.
The supplied names may be in any order. Those prefixed by a '#' represent compulsory values.<br />
<code>#Isgroup,#Name,Alias,Description,Keywords,Image,Notice,BookNotice,Membersnamed,<br />
...
$lang['help_account'] = 'Must be provided for a registered booker';
...
$lang['help_reportfrom'] = 'Report bookings starting from this date (as YYYY-[M]M, default earliest record)';
$lang['help_reportto'] = 'Report bookings to this date (as YYYY-[M]M, default latest record)';
$lang['help_showfrom'] = 'Display bookings starting from this date (as YYYY-[M]M-[D]D, default current day)';
...
$lang['nodata'] = 'No booking is recorded.';
$lang['nodata_one'] = 'No booking is recorded for %s.';
$lang['nodata_range'] = 'From %s to %s no booking is recorded.';
$lang['nofees'] = 'No fee is recorded.';
$lang['nofinds'] = 'Nothing matches the criteria';
$lang['nogroups'] = 'No resource-group is recorded.';
$lang['noitems'] = 'No resource is recorded.';
...
$lang['report_title'] = '%s %s';
$lang['report_title_post'] = '%s %s - from %s';
$lang['report_title_pre'] = '%s %s - to %s';
$lang['report_title_range'] = '%s %s - %s to %s';
...
$lang['stat_topay'] = 'None';
$lang['stat_unpaid'] = 'None';
$lang['status'] = 'Status';
$lang['submit'] = 'Submit';
...
$lang['tip_adminpaytype'] = 'administer %s payments';
...
$lang['tip_book'] = 'initiate/change booking';
$lang['tip_calendar'] = 'select a date';
...
$lang['tip_creditchange'] = 'adjust total adjustment by the entered amount';
$lang['tip_creditset'] = 'set total adjustment to the entered amount';
$lang['tip_delbooking'] = 'cancel this booking you\'ve made';
...
$lang['tip_display'] = 'select display interval';
...
$lang['tip_paidchange'] = 'adjust paid amount';
$lang['tip_paidchange_sel'] = 'adjust paid amount for selected item(s)';
$lang['tip_paidrefund'] = 'refund paid amount';
//$lang['tip_paidrefund_sel'] = 'refund paid amount for selected item(s)';
$lang['tip_paidset'] = 'set different paid amount';
$lang['tip_paidset_sel'] = 'set paid amount for selected item(s)';
...
$lang['tip_report_interval'] = 'modify report-range';
$lang['tip_seetype'] = 'inspect %s bookings';
$lang['tip_seepaytype'] = 'inspect %s payments';
...
$lang['title_bulletin'] = 'Optional notice for bookings-display pages';
$lang['title_bulletin2'] = 'Optional notice for make-booking pages';
...
$lang['title_credit'] = 'Credit';
$lang['title_credit2'] = 'Accumulated under/over payment';
...
$lang['title_delete'] = 'Delete your account';
...
$lang['title_ending'] = 'and end'; //'and ending when';
...
$lang['title_howmany'] = 'Number of %s'; //'How many of the %s?';
...
$lang['title_period'] = 'Interval'; //see also 'interval'
...
$lang['title_report_change'] = 'Change Report Interval';
...
$lang['title_reset'] = 'Change your password for the bookings system';
$lang['title_selecttype'] = 'Select type';
...
$lang['title_starting'] = 'Booking start'; //'Starting when';
...
//messages - inward
$lang['email_delete'] = 'A booking of %s has been cancelled.';
...
$lang['email_reqdelete'] = 'A request to cancel booking of %s has been submitted.';
...
//sms|tweet
$lang['text_delete'] = 'Booking cancelled, %s.';
$lang['text_reqdelete'] = 'Booking-cancellation requested, %s.';
