			...
			foreach ($this->Data as &$row) {
				...
				for ($ic = 0; $ic < $this->calcscount; $ic++) {
					...
					if (!isset($bktValues[$k0][$k1][$k2][$k])) {
						$bktValues[$k0][$k1][$k2][$k] = null;
					}
					$store = &$bktValues[$k0][$k1][$k2][$k];
					$v = $row[$k];
			...
			foreach ($this->Data as &$row) {
				...
				for ($ic = 0; $ic < $this->calcscount; $ic++) {
					...
					if (!isset($bktValues[$k0][$k1][$k2][$row[$g0]][$k])) {
						$bktValues[$k0][$k1][$k2][$row[$g0]][$k] = null;
					}
					$store = &$bktValues[$k0][$k1][$k2][$row[$g0]][$k];
					$v = $row[$k];
					switch ($this->colOps[$ic]) {
						case self::GRP_SUM:
						case self::GRP_CALL:
			...
			foreach ($this->Data as &$row) {
				...
				for ($ic = 0; $ic < $this->calcscount; $ic++) {
					...
					if (!isset($bktValues[$k0][$k1][$k2][$row[$g0]][$row[$g1]][$k])) {
						$bktValues[$k0][$k1][$k2][$row[$g0]][$row[$g1]][$k] = null;
					}
					$store = &$bktValues[$k0][$k1][$k2][$row[$g0]][$row[$g1]][$k];
					$v = $row[$k];
					switch ($this->colOps[$ic]) {
						case self::GRP_SUM:
						case self::GRP_CALL:
